          ...
          <ul className='Projets_grid'>
            <li className='liBooki'>
              ...
              {<ul>
                ...
                {<p>Les difficultées on été essentiellement de la mise en page css et du balisage sémentique.</p>}
              </ul>}/>
            </li>
            <li className='liArchiWebos'>
              ...
              <Collapse title="Description du projet ArchiWebos" content=
                {<ul>
                  ...
                  {<p>Sur ce projet, j'ai appris à utiliser les méthodes fetch (await et then) ainsi que l'identification par token. Il a été surtout centré sur l'apprentissage du JavaScript.</p>}
                </ul>}/>
            </li>
            <li className='liNina'>
                <h3>Nina Carducci</h3>
              ...
              <Collapse title="Description du projet Nina Carducci" content=
                {<ul>
                  ...
                  {<p>Ce projet m'a permis d'apprendre les différentes règles pour, le SEO, l'accessibilité, l'optimisation, le débug et le référencement.</p>}
                </ul>}/>            
                </li>
              <li className='liKasa'>
              <h3>Kasa</h3>
              ...
              <Collapse title="Description du projet Kasa" content=
                {<ul>
                  ...
                  {<p>Ce projet m'a appris l'utilisation de React, ainsi que la relation entre JavaScript et une base de données pour en extraire les informations.</p>}
                </ul>}/>
            </li>
